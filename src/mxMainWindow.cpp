...
//	EVT_MENU(mxID_EDIT_TOOLBAR_FIND, mxMainWindow::OnToolbarFindEnter)
	EVT_SEARCHCTRL_SEARCH_BTN(mxID_TOOLBAR_FIND, mxMainWindow::OnToolbarFindEnter)
...
//	EVT_MENU(mxID_RUN_BUILD, mxMainWindow::OnRunBuild)
	...
	EVT_MENU(mxID_TOOLS_SANITIZERS_ADDRESS, mxMainWindow::OnToolsSanitizersAddress)
	EVT_MENU(mxID_TOOLS_SANITIZERS_MEMORY, mxMainWindow::OnToolsSanitizersMemory)
	EVT_MENU(mxID_TOOLS_SANITIZERS_THREAD, mxMainWindow::OnToolsSanitizersThread)
	EVT_MENU(mxID_TOOLS_SANITIZERS_UNDEFINED, mxMainWindow::OnToolsSanitizersUndefined)
	EVT_MENU(mxID_TOOLS_SANITIZERS_LEAK, mxMainWindow::OnToolsSanitizersLeak)
