...
void mxCalltip::SetArg (int cur_arg) {
	...
	// obtener tamaņo de letras para calcular el tamaņo de la ventana y la longitud de las lineas
	my_font.SetWeight(wxFONTWEIGHT_BOLD); 
	...
	// (como no se sabe el tamaņo de la pantalla, se asume de 0,0 hasta la esquina inferior derecha de main_window)
	int delta_w=0;
	if (delta_chars) {
