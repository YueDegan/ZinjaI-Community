...
- `AAA_Palabras_Reservadas`
- `AAA_Palabras_Reservadas_11`
- `AAA_Estandar_C`
- `AAA_Estandar_Cpp`
- `AAA_Estandar_Cpp_11`
- `AAA_STL`
...
- Manual del Desarrollador → Módulo **Autocompletado**.
- Referencia técnica (Doxygen), cuando el código del motor de autocompletado sea documentado.
